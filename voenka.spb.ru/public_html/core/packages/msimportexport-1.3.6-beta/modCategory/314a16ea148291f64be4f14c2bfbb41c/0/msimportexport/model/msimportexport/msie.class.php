...
class Msie
{
    ...
    {
        return $this->modx->getObject('msCategory', $this->getRootCategoryId());
    }
     ...
     */
    private function addSeoKeywords($keywords = '', $resourceId)
    {
     ...
     * @return int
     */
    private function checkPageTitle($pageTitle, $id = 0, $parent = 0)
    {
        ...
        $q->where(array('pagetitle' => $pageTitle));
     ...
     * @return array
     */
    private function updateProducts($filename = '', $preset, $seek = 0)
    {
        $out = array(
            'errors' => 0,
            'create' => 0,
        ...
        $seek = $reader->getSeek();
        if ($seek < 0) {
            $this->invokeEvent('msieOnCompleteUpdateProduct', array());
            $this->clearUploadDir();
        }
    ...
    public function import($filename = '', $preset, $type = 'products', $seek = 0)
    {
        ...
        switch ($type) {
            ...
            case 'update_products':
                $out = $this->updateProducts($filename, $preset, $seek);
                break;
            default:
     ...
     * @return bool
     */
    public function export($to = 'csv', $preset = 0, $save = false, $type = 'products', $path = '', $filename = '', $categories = '')
    {
     ...
     * @return string
     */
    public function exportToYmarket($save = false, $path = '', $filename = '', $categories = '')
    {

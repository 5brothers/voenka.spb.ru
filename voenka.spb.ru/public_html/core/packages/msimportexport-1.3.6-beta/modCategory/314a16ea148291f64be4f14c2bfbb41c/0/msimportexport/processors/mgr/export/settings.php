...
if (isset($scriptProperties['image_scheme'])) {
    $scheme = filter_var($scriptProperties['image_scheme'], FILTER_VALIDATE_BOOLEAN) ? 1 : 0;
    $msie->setOption('msimportexport.export.image_scheme', $scheme, false);
}

...
if (isset($scriptProperties['memory_limit'])) {
    $msie->setOption('msimportexport.memory_limit', (int)$scriptProperties['memory_limit'], false);
}
...
if (isset($scriptProperties['auto_set_field'])) {
    $ignore_first_line = filter_var($scriptProperties['auto_set_field'], FILTER_VALIDATE_BOOLEAN) ? 1 : 0;
    $msie->setOption('msimportexport.import.auto_set_field', $ignore_first_line, false);
}
...
if (isset($scriptProperties['check_page_title'])) {
    $check_page_title = filter_var($scriptProperties['check_page_title'], FILTER_VALIDATE_BOOLEAN) ? 1 : 0;
    $msie->setOption('msimportexport.import.check_page_title', $check_page_title, false);
}

if (isset($scriptProperties['path_php_interpreter'])) {
    $msie->setOption('msimportexport.import.path_php_interpreter', $scriptProperties['path_php_interpreter'], false);
}
